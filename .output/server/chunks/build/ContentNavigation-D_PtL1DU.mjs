...
import { a as useContentDisabled, u as useAsyncData, q as queryContent, w as withContentBase, e as encodeQueryParams, b as addPrerenderPath, s as shouldUseClientDB, j as jsonStringify } from './query-DorxOe7R.mjs';
import { u as useContentPreview } from './preview-C2JMzfyq.mjs';
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import('./client-db-CdX4V79O.mjs').then((m) => m.generateNavigation);
...
//# sourceMappingURL=ContentNavigation-D_PtL1DU.mjs.map
