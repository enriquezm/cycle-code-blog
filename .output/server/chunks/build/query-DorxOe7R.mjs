...
import { b as useNuxtApp, c as asyncDataDefaults, a as useRuntimeConfig, d as createError } from './server.mjs';
import { K as withBase, w as withLeadingSlash, o as joinURL, r as withoutTrailingSlash } from '../nitro/nitro.mjs';
import { h as hash } from '../_/index.mjs';
import { a as useRequestEvent, u as useContentPreview } from './preview-C2JMzfyq.mjs';
...
const createQueryFetch = () => async (query) => {
  ...
  if (shouldUseClientDB()) {
    const db = await import('./client-db-CdX4V79O.mjs').then((m) => m.useContentDatabase());
...
//# sourceMappingURL=query-DorxOe7R.mjs.map
